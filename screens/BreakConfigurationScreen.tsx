...
const BreakConfigurationScreen: React.FC<BreakConfigurationScreenProps> = ({ navigateTo }) => {
    ...
    const handleEditException = (excepcion: Excepcion) => {
        ...
        setExceptionDateFrom(excepcion.fechaDesde.toLocaleDateString('es-ES', {
            day: '2-digit',
            month: '2-digit',
            year: 'numeric'
        }));
        setExceptionDateTo(excepcion.fechaHasta.toLocaleDateString('es-ES', {
            day: '2-digit',
            month: '2-digit',
            year: 'numeric'
        }));
