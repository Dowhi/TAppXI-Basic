            ...
            <div className="flex-1 overflow-y-auto p-4">
                {loading ? (
                    ...
                    <>
                        ...
                        {/* Nota informativa */}
                        <div className={`${cardBg} rounded-lg p-3 mt-4 border ${isDark ? 'border-yellow-500/30 bg-yellow-900/10' : 'border-yellow-300 bg-yellow-50'}`}>
                            <div className={`text-xs ${isDark ? 'text-yellow-300' : 'text-yellow-800'}`}>
                                ...
                                <p>
                                    ...
                                    Para información oficial en tiempo real, consulta la web de ADIF o Renfe.
                                </p>
                            </div>
                        </div>
                    </>
